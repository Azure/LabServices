...
$labPlans = $CsvConfigFile | Import-LabsCsv | New-AzLabPlansBulk -ThrottleLimit $ThrottleLimit

$labPlans | Export-LabsCsv -CsvConfigFile $CsvOutputFile -Force:$force.IsPresent
