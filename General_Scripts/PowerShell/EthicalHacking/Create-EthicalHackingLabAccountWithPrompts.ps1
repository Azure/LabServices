...
Invoke-WebRequest "https://raw.githubusercontent.com/Azure/LabServices/main/General_Scripts/PowerShell/EthicalHacking/Create-EthicalHacking-LabsAccount.ps1" -OutFile Create-EthicalHacking-LabsAccount.ps1
