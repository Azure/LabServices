...
7. [BringImageToSharedImageGallery](./BringImageToSharedImageGallery): This script imports an image from an Azure VM to Azure Compute Gallery (formerly Shared Image Gallery).
